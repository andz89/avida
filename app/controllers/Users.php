...
class Users extends Controller
{
  ...
  {
    $user_details = $this->userModel->get_user_details($_SESSION['user_id']);
    $data =  [
      'user_name' => $user_details->name,
      'user_email' => $user_details->email,
      'user_contact_number' => $user_details->contact_number,
      'user_created' => $user_details->date
  ...
  public function update_account()
  {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $profile = $this->userModel->get_user_details($_SESSION['user_id']);
