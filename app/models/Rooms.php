<?php
  class Rooms {
    ...
    public function add_room($data){
      ...
      $this->db->query('INSERT INTO rooms (room_name, room_amount, number_of_rooms, description_1, description_2,image_path,image_filename) VALUES(:room_name, :room_amount, :number_of_rooms, :description_1, :description_2,:image_path,:image_filename)');
      // Bind values
    ...
    public function insert_booking($data){
      ...
      $this->db->query('INSERT INTO book (booking_id,booking_fee, user_id, user_name,user_email,room_id,room_name, number_adults, number_children,booking_dates,check_in_and_out) VALUES(:booking_id,:booking_fee, :user_id, :user_name,:user_email, :room_id, :room_name,:number_adults,:number_children,:booking_dates,:check_in_and_out)');
      // Bind values
